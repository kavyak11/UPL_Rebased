...
[PcdsDynamicExDefault]
  ...
  #
  # Explictly define below dynamic PCDs (used by modules in UefiPayloadPkg) as dynamic EX 
  #
...
[Components.X64]
  ...
  #
  MdeModulePkg/Universal/SecurityStubDxe/SecurityStubDxe.inf #TODO: How it supports secure boot and measured boot?
